...
mechatronics.to_csv("mechatronics_ocupability.csv", index=False)
bionics.to_csv("bionics_ocupability.csv", index=False)
telematicss.to_csv("telematics_ocupability.csv", index=False)
